...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "vectorplot.lic_internal",
        "sources": [
            "vectorplot/lic_internal.pyx"
        ]
    },
    "module_name": "vectorplot.lic_internal"
}
END: Cython Metadata */
...
#define __PYX_HAVE__vectorplot__lic_internal
#define __PYX_HAVE_API__vectorplot__lic_internal
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'vectorplot.lic_internal' */
static void __pyx_f_10vectorplot_12lic_internal__advance(float, float, int *, int *, float *, float *, int, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_float = { "float", NULL, sizeof(float), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "vectorplot.lic_internal"
extern int __pyx_module_is_main_vectorplot__lic_internal;
int __pyx_module_is_main_vectorplot__lic_internal = 0;

/* Implementation of 'vectorplot.lic_internal' */
...
static const char __pyx_k_last_ui[] = "last_ui";
static const char __pyx_k_last_vi[] = "last_vi";
...
static const char __pyx_k_vectorplot_lic_internal[] = "vectorplot.lic_internal";
static const char __pyx_k_line_integral_convolution[] = "line_integral_convolution";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_vectorplot_lic_internal_pyx[] = "vectorplot/lic_internal.pyx";
static const char __pyx_k_Algorithm_based_on_Imaging_Veco[] = "\nAlgorithm based on \"Imaging Vecotr Fields Using Line Integral Convolution\" \n                   by Brian Cabral and Leith Leedom\n\n";
...
static PyObject *__pyx_n_s_vectorplot_lic_internal;
static PyObject *__pyx_kp_s_vectorplot_lic_internal_pyx;
static PyObject *__pyx_n_s_vi;
static PyObject *__pyx_n_s_w;
static PyObject *__pyx_n_s_x;
static PyObject *__pyx_n_s_y;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_10vectorplot_12lic_internal_line_integral_convolution(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_u, PyArrayObject *__pyx_v_v, PyArrayObject *__pyx_v_texture, PyArrayObject *__pyx_v_kernel, PyObject *__pyx_v_polarization); /* proto */
...
static void __pyx_f_10vectorplot_12lic_internal__advance(float __pyx_v_vx, float __pyx_v_vy, int *__pyx_v_x, int *__pyx_v_y, float *__pyx_v_fx, float *__pyx_v_fy, int __pyx_v_w, int __pyx_v_h) {
  float __pyx_v_tx;
  float __pyx_v_ty;
  int __pyx_v_zeros;
  ...
  /* "vectorplot/lic_internal.pyx":38
 *     cdef int zeros
 * 
 *     zeros = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":43
 *     # along x (y).
 * 
 *     if vx>0:             # <<<<<<<<<<<<<<
 *         tx = (1-fx[0])/vx
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":44
 * 
 *     if vx>0:
 *         tx = (1-fx[0])/vx             # <<<<<<<<<<<<<<
 *     elif vx<0:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":45
 *     if vx>0:
 *         tx = (1-fx[0])/vx
 *     elif vx<0:             # <<<<<<<<<<<<<<
 *         tx = -fx[0]/vx
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":46
 *         tx = (1-fx[0])/vx
 *     elif vx<0:
 *         tx = -fx[0]/vx             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":48
 *         tx = -fx[0]/vx
 *     else:
 *         zeros += 1             # <<<<<<<<<<<<<<
 *         tx = 1e100
 ...
 */
  /*else*/ {
    ...
    /* "vectorplot/lic_internal.pyx":49
 *     else:
 *         zeros += 1
 *         tx = 1e100             # <<<<<<<<<<<<<<
 *     if vy>0:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":50
 *         zeros += 1
 *         tx = 1e100
 *     if vy>0:             # <<<<<<<<<<<<<<
 *         ty = (1-fy[0])/vy
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":51
 *         tx = 1e100
 *     if vy>0:
 *         ty = (1-fy[0])/vy             # <<<<<<<<<<<<<<
 *     elif vy<0:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":52
 *     if vy>0:
 *         ty = (1-fy[0])/vy
 *     elif vy<0:             # <<<<<<<<<<<<<<
 *         ty = -fy[0]/vy
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":53
 *         ty = (1-fy[0])/vy
 *     elif vy<0:
 *         ty = -fy[0]/vy             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":55
 *         ty = -fy[0]/vy
 *     else:
 *         zeros += 1             # <<<<<<<<<<<<<<
 *         ty = 1e100
 ...
 */
  /*else*/ {
    ...
    /* "vectorplot/lic_internal.pyx":56
 *     else:
 *         zeros += 1
 *         ty = 1e100             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":58
 *         ty = 1e100
 * 
 *     if zeros==2:             # <<<<<<<<<<<<<<
 *         return
 * 
 */
  __pyx_t_1 = ((__pyx_v_zeros == 2) != 0);
  if (__pyx_t_1) {

    /* "vectorplot/lic_internal.pyx":59
 * 
 *     if zeros==2:
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":61
 *         return
 * 
 *     if tx<ty:    # We reached the next pixel along x first.             # <<<<<<<<<<<<<<
 *         if vx>=0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":62
 * 
 *     if tx<ty:    # We reached the next pixel along x first.
 *         if vx>=0:             # <<<<<<<<<<<<<<
 *             x[0]+=1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "vectorplot/lic_internal.pyx":63
 *     if tx<ty:    # We reached the next pixel along x first.
 *         if vx>=0:
 *             x[0]+=1             # <<<<<<<<<<<<<<
 *             fx[0]=0
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":64
 *         if vx>=0:
 *             x[0]+=1
 *             fx[0]=0             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "vectorplot/lic_internal.pyx":66
 *             fx[0]=0
 *         else:
 *             x[0]-=1             # <<<<<<<<<<<<<<
 *             fx[0]=1
 ...
 */
    /*else*/ {
      ...
      /* "vectorplot/lic_internal.pyx":67
 *         else:
 *             x[0]-=1
 *             fx[0]=1             # <<<<<<<<<<<<<<
 *         fy[0]+=tx*vy
 ...
 */
    ...
    /* "vectorplot/lic_internal.pyx":68
 *             x[0]-=1
 *             fx[0]=1
 *         fy[0]+=tx*vy             # <<<<<<<<<<<<<<
 *     else:        # We reached the next pixel along y first.
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":70
 *         fy[0]+=tx*vy
 *     else:        # We reached the next pixel along y first.
 *         if vy>=0:             # <<<<<<<<<<<<<<
 *             y[0]+=1
 ...
 */
  /*else*/ {
    ...
    if (__pyx_t_1) {
      ...
      /* "vectorplot/lic_internal.pyx":71
 *     else:        # We reached the next pixel along y first.
 *         if vy>=0:
 *             y[0]+=1             # <<<<<<<<<<<<<<
 *             fy[0]=0
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":72
 *         if vy>=0:
 *             y[0]+=1
 *             fy[0]=0             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "vectorplot/lic_internal.pyx":74
 *             fy[0]=0
 *         else:
 *             y[0]-=1             # <<<<<<<<<<<<<<
 *             fy[0]=1
 ...
 */
    /*else*/ {
      ...
      /* "vectorplot/lic_internal.pyx":75
 *         else:
 *             y[0]-=1
 *             fy[0]=1             # <<<<<<<<<<<<<<
 *         fx[0]+=ty*vx
 ...
 */
    ...
    /* "vectorplot/lic_internal.pyx":76
 *             y[0]-=1
 *             fy[0]=1
 *         fx[0]+=ty*vx             # <<<<<<<<<<<<<<
 *     if x[0]>=w:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":77
 *             fy[0]=1
 *         fx[0]+=ty*vx
 *     if x[0]>=w:             # <<<<<<<<<<<<<<
 *         x[0]=w-1 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":78
 *         fx[0]+=ty*vx
 *     if x[0]>=w:
 *         x[0]=w-1 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 *     if x[0]<0:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":79
 *     if x[0]>=w:
 *         x[0]=w-1 # FIXME: other boundary conditions?
 *     if x[0]<0:             # <<<<<<<<<<<<<<
 *         x[0]=0 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":80
 *         x[0]=w-1 # FIXME: other boundary conditions?
 *     if x[0]<0:
 *         x[0]=0 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 *     if y[0]<0:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":81
 *     if x[0]<0:
 *         x[0]=0 # FIXME: other boundary conditions?
 *     if y[0]<0:             # <<<<<<<<<<<<<<
 *         y[0]=0 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":82
 *         x[0]=0 # FIXME: other boundary conditions?
 *     if y[0]<0:
 *         y[0]=0 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 *     if y[0]>=h:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":83
 *     if y[0]<0:
 *         y[0]=0 # FIXME: other boundary conditions?
 *     if y[0]>=h:             # <<<<<<<<<<<<<<
 *         y[0]=h-1 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "vectorplot/lic_internal.pyx":84
 *         y[0]=0 # FIXME: other boundary conditions?
 *     if y[0]>=h:
 *         y[0]=h-1 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("vectorplot.lic_internal._advance", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "vectorplot/lic_internal.pyx":88
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_10vectorplot_12lic_internal_1line_integral_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10vectorplot_12lic_internal_line_integral_convolution[] = "Return an image of the texture array blurred along the local \n    vector field orientation. \n\n    Parameters\n    ----------\n    u : array (ny, nx)\n      Vector field x component.\n    v : array (ny, nx)\n      Vector field y component.\n    texture : array (ny,nx)\n      The texture image that will be distorted by the vector field. \n      Usually, a white noise image is recommended to display the \n      fine structure of the vector field. \n    kernel : 1D array \n      The convolution kernel: an array weighting the texture along\n      the stream line. For static images, a box kernel (equal to one)\n      of length max(nx,ny)/10 is appropriate. The kernel should be \n      symmetric.\n    polarization : boolean\n      If True, treat the vector field as a polarization (so that the\n      vectors have no distinction between forward and backward).\n      \n    Returns\n    -------\n    out : array(ny,nx)\n      An image of the texture convoluted along the vector field \n      streamlines. \n      \n    ";
static PyMethodDef __pyx_mdef_10vectorplot_12lic_internal_1line_integral_convolution = {"line_integral_convolution", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10vectorplot_12lic_internal_1line_integral_convolution, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10vectorplot_12lic_internal_line_integral_convolution};
static PyObject *__pyx_pw_10vectorplot_12lic_internal_1line_integral_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_u,&__pyx_n_s_v,&__pyx_n_s_texture,&__pyx_n_s_kernel,&__pyx_n_s_polarization,0};
    PyObject* values[5] = {0,0,0,0,0};

    /* "vectorplot/lic_internal.pyx":93
 ...
 */
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("line_integral_convolution", 0, 4, 5, 1); __PYX_ERR(0, 88, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_texture)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("line_integral_convolution", 0, 4, 5, 2); __PYX_ERR(0, 88, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kernel)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("line_integral_convolution", 0, 4, 5, 3); __PYX_ERR(0, 88, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_polarization);
          if (value) { values[4] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "line_integral_convolution") < 0)) __PYX_ERR(0, 88, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_kernel = ((PyArrayObject *)values[3]);
    __pyx_v_polarization = values[4];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("line_integral_convolution", 0, 4, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 88, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("vectorplot.lic_internal.line_integral_convolution", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_u), __pyx_ptype_5numpy_ndarray, 1, "u", 0))) __PYX_ERR(0, 89, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_v), __pyx_ptype_5numpy_ndarray, 1, "v", 0))) __PYX_ERR(0, 90, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_texture), __pyx_ptype_5numpy_ndarray, 1, "texture", 0))) __PYX_ERR(0, 91, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_kernel), __pyx_ptype_5numpy_ndarray, 1, "kernel", 0))) __PYX_ERR(0, 92, __pyx_L1_error)
  __pyx_r = __pyx_pf_10vectorplot_12lic_internal_line_integral_convolution(__pyx_self, __pyx_v_u, __pyx_v_v, __pyx_v_texture, __pyx_v_kernel, __pyx_v_polarization);
...
static PyObject *__pyx_pf_10vectorplot_12lic_internal_line_integral_convolution(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_u, PyArrayObject *__pyx_v_v, PyArrayObject *__pyx_v_texture, PyArrayObject *__pyx_v_kernel, PyObject *__pyx_v_polarization) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_x;
  ...
  float __pyx_v_ui;
  float __pyx_v_vi;
  float __pyx_v_last_ui;
  float __pyx_v_last_vi;
  ...
  __pyx_pybuffernd_kernel.rcbuffer = &__pyx_pybuffer_kernel;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_u.rcbuffer->pybuffer, (PyObject*)__pyx_v_u, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 88, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_v.rcbuffer->pybuffer, (PyObject*)__pyx_v_v, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 88, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_texture.rcbuffer->pybuffer, (PyObject*)__pyx_v_texture, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 88, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_kernel.rcbuffer->pybuffer, (PyObject*)__pyx_v_kernel, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 88, __pyx_L1_error)
  }
  ...
  /* "vectorplot/lic_internal.pyx":132
 *     cdef int pol
 * 
 *     if polarization:             # <<<<<<<<<<<<<<
 *         pol = 1
 *     else:
 */
  __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_v_polarization); if (unlikely(__pyx_t_1 < 0)) __PYX_ERR(0, 132, __pyx_L1_error)
  if (__pyx_t_1) {

    /* "vectorplot/lic_internal.pyx":133
 * 
 *     if polarization:
 *         pol = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":135
 *         pol = 1
 *     else:
 *         pol = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":137
 *         pol = 0
 * 
 *     ny = u.shape[0]             # <<<<<<<<<<<<<<
 *     nx = u.shape[1]
 * 
 */
  __pyx_v_ny = (__pyx_v_u->dimensions[0]);

  /* "vectorplot/lic_internal.pyx":138
 * 
 *     ny = u.shape[0]
 *     nx = u.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_nx = (__pyx_v_u->dimensions[1]);

  /* "vectorplot/lic_internal.pyx":140
 *     nx = u.shape[1]
 * 
 *     kernellen = kernel.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "vectorplot/lic_internal.pyx":142
 *     kernellen = kernel.shape[0]
 * 
 *     result = np.zeros((ny,nx),dtype=np.float32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_ny); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_nx); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 142, __pyx_L1_error)
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_float32); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 142, __pyx_L1_error)
  ...
  /* "vectorplot/lic_internal.pyx":144
 *     result = np.zeros((ny,nx),dtype=np.float32)
 * 
 *     for i in range(ny):             # <<<<<<<<<<<<<<
 *         for j in range(nx):
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_13; __pyx_t_8+=1) {
    ...
    /* "vectorplot/lic_internal.pyx":145
 * 
 *     for i in range(ny):
 *         for j in range(nx):             # <<<<<<<<<<<<<<
 *             x = j
 ...
 */
    ...
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      ...
      /* "vectorplot/lic_internal.pyx":146
 *     for i in range(ny):
 *         for j in range(nx):
 *             x = j             # <<<<<<<<<<<<<<
 *             y = i
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":147
 *         for j in range(nx):
 *             x = j
 *             y = i             # <<<<<<<<<<<<<<
 *             fx = 0.5
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":148
 *             x = j
 *             y = i
 *             fx = 0.5             # <<<<<<<<<<<<<<
 *             fy = 0.5
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":149
 *             y = i
 *             fx = 0.5
 *             fy = 0.5             # <<<<<<<<<<<<<<
 *             last_ui = 0
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":150
 *             fx = 0.5
 *             fy = 0.5
 *             last_ui = 0             # <<<<<<<<<<<<<<
 *             last_vi = 0
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":151
 *             fy = 0.5
 *             last_ui = 0
 *             last_vi = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":153
 *             last_vi = 0
 * 
 *             k = kernellen//2             # <<<<<<<<<<<<<<
 *             #print i, j, k, x, y
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":155
 *             k = kernellen//2
 *             #print i, j, k, x, y
 *             result[i,j] += kernel[k]*texture[y,x]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_result.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_result.diminfo[1].strides) += ((*__Pyx_BufPtrStrided1d(float *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_kernel.diminfo[0].strides)) * (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_texture.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_texture.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_texture.diminfo[1].strides)));
      ...
      /* "vectorplot/lic_internal.pyx":157
 *             result[i,j] += kernel[k]*texture[y,x]
 * 
 *             while k<kernellen-1:             # <<<<<<<<<<<<<<
 *                 ui = u[y,x]
 ...
 */
      while (1) {
        ...
        /* "vectorplot/lic_internal.pyx":158
 * 
 *             while k<kernellen-1:
 *                 ui = u[y,x]             # <<<<<<<<<<<<<<
 *                 vi = v[y,x]
 ...
 */
        ...
        } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_u.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_24 < 0) {
          __pyx_t_24 += __pyx_pybuffernd_u.diminfo[1].shape;
          if (unlikely(__pyx_t_24 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_u.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 158, __pyx_L1_error)
        }
        __pyx_v_ui = (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_u.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_u.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_u.diminfo[1].strides));

        /* "vectorplot/lic_internal.pyx":159
 *             while k<kernellen-1:
 *                 ui = u[y,x]
 *                 vi = v[y,x]             # <<<<<<<<<<<<<<
 *                 if pol and (ui*last_ui+vi*last_vi)<0:
 ...
 */
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_25 < 0) {
          __pyx_t_25 += __pyx_pybuffernd_v.diminfo[0].shape;
          if (unlikely(__pyx_t_25 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_v.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_26 < 0) {
          __pyx_t_26 += __pyx_pybuffernd_v.diminfo[1].shape;
          if (unlikely(__pyx_t_26 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_26 >= __pyx_pybuffernd_v.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 159, __pyx_L1_error)
        }
        __pyx_v_vi = (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_v.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_v.diminfo[1].strides));

        /* "vectorplot/lic_internal.pyx":160
 *                 ui = u[y,x]
 *                 vi = v[y,x]
 *                 if pol and (ui*last_ui+vi*last_vi)<0:             # <<<<<<<<<<<<<<
 *                     ui = -ui
 *                     vi = -vi
 */
        __pyx_t_27 = (__pyx_v_pol != 0);
        if (__pyx_t_27) {
        } else {
          __pyx_t_1 = __pyx_t_27;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_27 = ((((__pyx_v_ui * __pyx_v_last_ui) + (__pyx_v_vi * __pyx_v_last_vi)) < 0.0) != 0);
        __pyx_t_1 = __pyx_t_27;
        __pyx_L11_bool_binop_done:;
        if (__pyx_t_1) {

          /* "vectorplot/lic_internal.pyx":161
 *                 vi = v[y,x]
 *                 if pol and (ui*last_ui+vi*last_vi)<0:
 *                     ui = -ui             # <<<<<<<<<<<<<<
 *                     vi = -vi
 *                 last_ui = ui
 */
          __pyx_v_ui = (-__pyx_v_ui);

          /* "vectorplot/lic_internal.pyx":162
 *                 if pol and (ui*last_ui+vi*last_vi)<0:
 *                     ui = -ui
 *                     vi = -vi             # <<<<<<<<<<<<<<
 *                 last_ui = ui
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":163
 *                     ui = -ui
 *                     vi = -vi
 *                 last_ui = ui             # <<<<<<<<<<<<<<
 *                 last_vi = vi
 *                 _advance(ui,vi,
 */
        __pyx_v_last_ui = __pyx_v_ui;

        /* "vectorplot/lic_internal.pyx":164
 *                     vi = -vi
 *                 last_ui = ui
 *                 last_vi = vi             # <<<<<<<<<<<<<<
 *                 _advance(ui,vi,
 *                         &x, &y, &fx, &fy, nx, ny)
 */
        __pyx_v_last_vi = __pyx_v_vi;

        /* "vectorplot/lic_internal.pyx":165
 *                 last_ui = ui
 *                 last_vi = vi
 *                 _advance(ui,vi,             # <<<<<<<<<<<<<<
 *                         &x, &y, &fx, &fy, nx, ny)
 *                 k+=1
 */
        __pyx_f_10vectorplot_12lic_internal__advance(__pyx_v_ui, __pyx_v_vi, (&__pyx_v_x), (&__pyx_v_y), (&__pyx_v_fx), (&__pyx_v_fy), __pyx_v_nx, __pyx_v_ny);

        /* "vectorplot/lic_internal.pyx":167
 *                 _advance(ui,vi,
 *                         &x, &y, &fx, &fy, nx, ny)
 *                 k+=1             # <<<<<<<<<<<<<<
 *                 #print i, j, k, x, y
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":169
 *                 k+=1
 *                 #print i, j, k, x, y
 *                 result[i,j] += kernel[k]*texture[y,x]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        } else if (unlikely(__pyx_t_28 >= __pyx_pybuffernd_kernel.diminfo[0].shape)) __pyx_t_18 = 0;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_29 < 0) {
          __pyx_t_29 += __pyx_pybuffernd_texture.diminfo[0].shape;
          if (unlikely(__pyx_t_29 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_29 >= __pyx_pybuffernd_texture.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_30 < 0) {
          __pyx_t_30 += __pyx_pybuffernd_texture.diminfo[1].shape;
          if (unlikely(__pyx_t_30 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_30 >= __pyx_pybuffernd_texture.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 169, __pyx_L1_error)
        }
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_31 < 0) {
          __pyx_t_31 += __pyx_pybuffernd_result.diminfo[0].shape;
          if (unlikely(__pyx_t_31 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_31 >= __pyx_pybuffernd_result.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_32 < 0) {
          __pyx_t_32 += __pyx_pybuffernd_result.diminfo[1].shape;
          if (unlikely(__pyx_t_32 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_32 >= __pyx_pybuffernd_result.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 169, __pyx_L1_error)
        }
        *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_result.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_result.diminfo[1].strides) += ((*__Pyx_BufPtrStrided1d(float *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_kernel.diminfo[0].strides)) * (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_texture.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_texture.diminfo[0].strides, __pyx_t_30, __pyx_pybuffernd_texture.diminfo[1].strides)));
      }

      /* "vectorplot/lic_internal.pyx":171
 *                 result[i,j] += kernel[k]*texture[y,x]
 * 
 *             x = j             # <<<<<<<<<<<<<<
 *             y = i
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":172
 * 
 *             x = j
 *             y = i             # <<<<<<<<<<<<<<
 *             fx = 0.5
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":173
 *             x = j
 *             y = i
 *             fx = 0.5             # <<<<<<<<<<<<<<
 *             fy = 0.5
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":174
 *             y = i
 *             fx = 0.5
 *             fy = 0.5             # <<<<<<<<<<<<<<
 *             last_ui = 0
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":175
 *             fx = 0.5
 *             fy = 0.5
 *             last_ui = 0             # <<<<<<<<<<<<<<
 *             last_vi = 0
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":176
 *             fy = 0.5
 *             last_ui = 0
 *             last_vi = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":178
 *             last_vi = 0
 * 
 *             k = kernellen//2             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "vectorplot/lic_internal.pyx":180
 *             k = kernellen//2
 * 
 *             while k>0:             # <<<<<<<<<<<<<<
 *                 ui = u[y,x]
 ...
 */
      while (1) {
        ...
        /* "vectorplot/lic_internal.pyx":181
 * 
 *             while k>0:
 *                 ui = u[y,x]             # <<<<<<<<<<<<<<
 *                 vi = v[y,x]
 ...
 */
        ...
        } else if (unlikely(__pyx_t_33 >= __pyx_pybuffernd_u.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_34 < 0) {
          __pyx_t_34 += __pyx_pybuffernd_u.diminfo[1].shape;
          if (unlikely(__pyx_t_34 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_34 >= __pyx_pybuffernd_u.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 181, __pyx_L1_error)
        }
        __pyx_v_ui = (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_u.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_u.diminfo[0].strides, __pyx_t_34, __pyx_pybuffernd_u.diminfo[1].strides));

        /* "vectorplot/lic_internal.pyx":182
 *             while k>0:
 *                 ui = u[y,x]
 *                 vi = v[y,x]             # <<<<<<<<<<<<<<
 *                 if pol and (ui*last_ui+vi*last_vi)<0:
 ...
 */
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_35 < 0) {
          __pyx_t_35 += __pyx_pybuffernd_v.diminfo[0].shape;
          if (unlikely(__pyx_t_35 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_35 >= __pyx_pybuffernd_v.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_36 < 0) {
          __pyx_t_36 += __pyx_pybuffernd_v.diminfo[1].shape;
          if (unlikely(__pyx_t_36 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_36 >= __pyx_pybuffernd_v.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 182, __pyx_L1_error)
        }
        __pyx_v_vi = (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_v.diminfo[0].strides, __pyx_t_36, __pyx_pybuffernd_v.diminfo[1].strides));

        /* "vectorplot/lic_internal.pyx":183
 *                 ui = u[y,x]
 *                 vi = v[y,x]
 *                 if pol and (ui*last_ui+vi*last_vi)<0:             # <<<<<<<<<<<<<<
 *                     ui = -ui
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "vectorplot/lic_internal.pyx":184
 *                 vi = v[y,x]
 *                 if pol and (ui*last_ui+vi*last_vi)<0:
 *                     ui = -ui             # <<<<<<<<<<<<<<
 *                     vi = -vi
 ...
 */
          ...
          /* "vectorplot/lic_internal.pyx":185
 *                 if pol and (ui*last_ui+vi*last_vi)<0:
 *                     ui = -ui
 *                     vi = -vi             # <<<<<<<<<<<<<<
 *                 last_ui = ui
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":186
 *                     ui = -ui
 *                     vi = -vi
 *                 last_ui = ui             # <<<<<<<<<<<<<<
 *                 last_vi = vi
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":187
 *                     vi = -vi
 *                 last_ui = ui
 *                 last_vi = vi             # <<<<<<<<<<<<<<
 *                 _advance(-ui,-vi,
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":188
 *                 last_ui = ui
 *                 last_vi = vi
 *                 _advance(-ui,-vi,             # <<<<<<<<<<<<<<
 *                         &x, &y, &fx, &fy, nx, ny)
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":190
 *                 _advance(-ui,-vi,
 *                         &x, &y, &fx, &fy, nx, ny)
 *                 k-=1             # <<<<<<<<<<<<<<
 *                 #print i, j, k, x, y
 ...
 */
        ...
        /* "vectorplot/lic_internal.pyx":192
 *                 k-=1
 *                 #print i, j, k, x, y
 *                 result[i,j] += kernel[k]*texture[y,x]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        } else if (unlikely(__pyx_t_37 >= __pyx_pybuffernd_kernel.diminfo[0].shape)) __pyx_t_18 = 0;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
        ...
        } else if (unlikely(__pyx_t_38 >= __pyx_pybuffernd_texture.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_39 < 0) {
          __pyx_t_39 += __pyx_pybuffernd_texture.diminfo[1].shape;
          if (unlikely(__pyx_t_39 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_39 >= __pyx_pybuffernd_texture.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 192, __pyx_L1_error)
        }
        ...
        } else if (unlikely(__pyx_t_40 >= __pyx_pybuffernd_result.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_41 < 0) {
          __pyx_t_41 += __pyx_pybuffernd_result.diminfo[1].shape;
          if (unlikely(__pyx_t_41 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_41 >= __pyx_pybuffernd_result.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 192, __pyx_L1_error)
        }
  ...
  /* "vectorplot/lic_internal.pyx":194
 *                 result[i,j] += kernel[k]*texture[y,x]
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "lic_internal",
    __pyx_k_Algorithm_based_on_Imaging_Veco, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_vectorplot_lic_internal, __pyx_k_vectorplot_lic_internal, sizeof(__pyx_k_vectorplot_lic_internal), 0, 0, 1, 1},
  {&__pyx_kp_s_vectorplot_lic_internal_pyx, __pyx_k_vectorplot_lic_internal_pyx, sizeof(__pyx_k_vectorplot_lic_internal_pyx), 0, 0, 1, 0},
 ...
 *         np.ndarray[float, ndim=2] v,
 */
  __pyx_tuple__8 = PyTuple_Pack(26, __pyx_n_s_u, __pyx_n_s_v, __pyx_n_s_texture, __pyx_n_s_kernel, __pyx_n_s_polarization, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_h, __pyx_n_s_w, __pyx_n_s_kernellen, __pyx_n_s_t, __pyx_n_s_fx, __pyx_n_s_fy, __pyx_n_s_tx, __pyx_n_s_ty, __pyx_n_s_ui, __pyx_n_s_vi, __pyx_n_s_last_ui, __pyx_n_s_last_vi, __pyx_n_s_result, __pyx_n_s_pol, __pyx_n_s_ny, __pyx_n_s_nx); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(5, 0, 26, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_vectorplot_lic_internal_pyx, __pyx_n_s_line_integral_convolution, 88, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("lic_internal", __pyx_methods, __pyx_k_Algorithm_based_on_Imaging_Veco, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_vectorplot__lic_internal) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "vectorplot.lic_internal")) {
      if (unlikely(PyDict_SetItemString(modules, "vectorplot.lic_internal", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         np.ndarray[float, ndim=2] v,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10vectorplot_12lic_internal_1line_integral_convolution, NULL, __pyx_n_s_vectorplot_lic_internal); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_line_integral_convolution, __pyx_t_1) < 0) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "vectorplot/lic_internal.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Algorithm based on "Imaging Vecotr Fields Using Line Integral Convolution"
 *                    by Brian Cabral and Leith Leedom
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init vectorplot.lic_internal", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init vectorplot.lic_internal");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
